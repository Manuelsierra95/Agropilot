    ...
    return (
      <Card className="col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-4">
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-medium">Lluvia (7d)</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">-- mm</div>
        </CardContent>
      </Card>
    )
  }
    ...
    <Card className="col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-4">
      ...
      <CardContent>
        <div className="flex items-baseline gap-2">
          <div className="text-2xl font-bold">{current.toFixed(1)} mm</div>
          <div
          ...
          >
            ...
            <span>{Math.abs(change).toFixed(1)} mm</span>
          </div>
        </div>
        <p className="text-xs text-muted-foreground mt-1">
          {isPositive ? '+' : ''}
          {changePercentage.toFixed(1)}% vs semana anterior
        </p>
      </CardContent>
    </Card>
  )
