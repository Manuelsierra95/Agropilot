...
export function PreviousHarvest() {
  ...
  return (
    <Card className="col-span-1 sm:col-span-1 md:col-span-2 lg:col-span-4">
      <CardHeader className="pb-2">
        <CardTitle className="text-sm font-medium">Cosecha anterior</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="flex items-baseline gap-2">
          <div className="text-2xl font-bold">
            {current.toLocaleString('es-ES')} kg
          </div>
          <div
        ...
        <p className="text-xs text-muted-foreground mt-1">
          {isPositive ? '+' : ''}
          {changePercentage.toFixed(1)}% vs año anterior
        </p>
      </CardContent>
    </Card>
  )
