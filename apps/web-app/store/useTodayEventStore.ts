...
interface ParcelTodayEventsCache {
  events: Event[]
  lastFetched: number
}

interface TodayEventState {
  eventsByParcel: Record<string, ParcelTodayEventsCache>
...
export const useTodayEventStore = create<TodayEventState>()(
  persist(
    (set, get) => ({
      eventsByParcel: {},
