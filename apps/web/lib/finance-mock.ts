...
export const TRANSACTIONS: Transaction[] = [
  { id: 1, date: "15 Mar 2025", description: "Venta aceite virgen extra – Coop. Jaén", category: "Venta",      amount: +12480, type: "income"  },
  { id: 2, date: "10 Mar 2025", description: "Reparación cosechadora",                 category: "Maquinaria", amount: -1850,  type: "expense" },
  { id: 3, date: "05 Mar 2025", description: "Fitosanitarios – tratamiento marzo",     category: "Insumos",    amount: -640,   type: "expense" },
  { id: 4, date: "28 Feb 2025", description: "Subvención PAC Q1",                      category: "Subvención", amount: +3200,  type: "income"  },
  { id: 5, date: "20 Feb 2025", description: "Venta aceite virgen – mercado local",    category: "Venta",      amount: +4320,  type: "income"  },
  { id: 6, date: "15 Feb 2025", description: "Fertilizantes abono de fondo",           category: "Insumos",    amount: -980,   type: "expense" },
  { id: 7, date: "10 Feb 2025", description: "Poda olivos – mano de obra",             category: "Laboral",    amount: -2100,  type: "expense" },
  { id: 8, date: "01 Feb 2025", description: "Seguro agrario anual",                   category: "Seguros",    amount: -720,   type: "expense" },
]
