...
export const metadata = {
  ...
  description: "Necesitas iniciar sesion para continuar.",
}

export default function UnauthorizedPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-white text-neutral-900">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(10,114,239,0.08),transparent_55%),radial-gradient(circle_at_bottom,rgba(0,0,0,0.08),transparent_45%)]" />
