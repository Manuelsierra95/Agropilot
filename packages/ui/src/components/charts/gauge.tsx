...
function interpolateHex(
  ...
  if (!HEX_COLOR.test(color1) || !HEX_COLOR.test(color2)) {
    const weight1 = (1 - t) * 100
    const weight2 = t * 100
    return `color-mix(in oklch, ${color1} ${weight1}%, ${color2} ${weight2}%)`
  }
